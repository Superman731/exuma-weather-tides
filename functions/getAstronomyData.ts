export default async function getAstronomyData() {
  ...
  if (data.status !== 'OK') {
    return {
      moonData: { phase: 'Waning Crescent', illumination: 15, moonrise: '4:30 AM', moonset: '5:15 PM' },
      skyData: {
      ...
      contextData: { latitude: '23.5° N', longitude: '75.8° W', seasonalMarker: '51 days until Spring Equinox', seaState: 'Calm' },
      lifestyleData: { fireWeather: 'Perfect', swimWeather: 'Perfect' }
    };
  }
